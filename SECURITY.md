...
The following versions of **PrepPilot** are currently supported with security updates:
...
To report a security vulnerability in **PrepPilot**, please reach out via:

- 👤 Github: [Canopus-Labs](https://github.com/Canopus-Labs)
- ✉️ Email: karanmanickam.dev@gmail.com
- 💬 LinkedIN: [Karan Manickam](https://www.linkedin.com/in/karanunix)
...
- [PrepPilot Repository](https://github.com/Canopus-Labs/PrepPilot)
